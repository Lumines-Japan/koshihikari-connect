...
const Hero = () => {
  return (
    <section className="relative pt-16 md:pt-[4.5rem] h-[calc(100vh-96px)] flex items-center justify-center bg-cover bg-center" style={{backgroundImage: 'url("/hero-background.jpg")'}}>
