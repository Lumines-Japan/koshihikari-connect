...
const Hero = () => {
  return (
    <section className="relative h-screen flex items-center justify-center bg-cover bg-center" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1568636403823-e9f0814d2074?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")'}}>
