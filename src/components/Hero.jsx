...
const Hero = () => {
  return (
    <section className="relative pt-[4.5rem] h-[calc(100vh-72px)] flex items-center justify-center bg-cover bg-center" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1601598851547-4302969d0614?ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80")'}}>
