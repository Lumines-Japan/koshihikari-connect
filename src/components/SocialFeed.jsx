...
const socialPosts = [
  {
    ...
    image: 'https://dffgvfuyuzktboucthiq.supabase.co/storage/v1/object/public/company-images/asset/photo-1633555412302-152f85ae4fe2.jpg'
  },
  {
    platform: 'Instagram',
    content: '朝日に輝く稲穂。自然の恵みに感謝しながら、今日も一日がんばります！ #田んぼの風景 #農家の日常',
    image: 'https://dffgvfuyuzktboucthiq.supabase.co/storage/v1/object/public/company-images/asset/photo-1730700521745-7648ef0abd0b.jpg'
  },
  {
    platform: 'Twitter',
    content: '新商品のお知らせ！今年の新米コシヒカリを使った「おにぎりセット」が登場です。ぜひお試しください！',
    image: 'https://dffgvfuyuzktboucthiq.supabase.co/storage/v1/object/public/company-images/asset/photo-1556906889-d7e0822cff22.jpg'
  }
];
