      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-snow-50 p-6 rounded-lg shadow-lg">
            <img src="https://dffgvfuyuzktboucthiq.supabase.co/storage/v1/object/public/company-images/asset/umedaLightroom_MG_4905_TP_V.jpg" alt="粒選別" className="w-full h-48 object-cover rounded-t-lg mb-4" />
          ...
          <div className="bg-snow-50 p-6 rounded-lg shadow-lg">
            <img src="https://dffgvfuyuzktboucthiq.supabase.co/storage/v1/object/public/company-images/asset/JYUN923_1_TP_V4.jpg" alt="自然環境" className="w-full h-48 object-cover rounded-t-lg mb-4" />
          ...
          <div className="bg-snow-50 p-6 rounded-lg shadow-lg">
            <img src="https://dffgvfuyuzktboucthiq.supabase.co/storage/v1/object/public/company-images/asset/kamameshiPAR50519_TP_V.jpg" alt="炊き上がり" className="w-full h-48 object-cover rounded-t-lg mb-4" />
