...
const Header = () => {
  ...
  return (
    <header className="bg-snow-50 shadow-md fixed top-0 left-0 right-0 z-50 h-24">
      <div className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center">
          ...
          <nav className={`${isMenuOpen ? 'block' : 'hidden'} md:block absolute top-24 left-0 w-full md:static md:w-auto bg-niigata-50 md:bg-transparent z-50`}>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 flex flex-col space-y-4">
            <ul className="flex flex-col space-y-4">
              <li><Link to="/#product" className="block py-2 px-4 text-niigata-800 hover:bg-niigata-100 transition-colors">商品紹介</Link></li>
              <li><Link to="/#farmers" className="block py-2 px-4 text-niigata-800 hover:bg-niigata-100 transition-colors">生産者紹介</Link></li>
              <li><Link to="/#recipes" className="block py-2 px-4 text-niigata-800 hover:bg-niigata-100 transition-colors">レシピ</Link></li>
              <li><Link to="/#reviews" className="block py-2 px-4 text-niigata-800 hover:bg-niigata-100 transition-colors">お客様の声</Link></li>
              <li><Link to="/#faq" className="block py-2 px-4 text-niigata-800 hover:bg-niigata-100 transition-colors">FAQ</Link></li>
            </ul>
